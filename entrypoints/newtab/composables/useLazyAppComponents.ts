...
export const Memo = defineAsyncComponent(() => import('../components/Memo/index.vue'))
...
export function useLazyAppComponents() {
  ...
  const memo = createLazyDialogState()
  ...
  return {
    ...
    memoMounted: memo.mounted,
    memoVisible: memo.visible,
